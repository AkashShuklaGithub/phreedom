...
{                   
    ...
    protected $_mno_request_message;
    protected $_mno_response_id;
    ...
    */
    ...
    public function getMnoRequestMessageAsObject() {
        return json_decode($this->_mno_request_message, false);
    }
    
    public function getMnoResponseId() {
        return $this->_mno_response_id;
    }
    
    public function getMnoEntity($notification) {
        return $this->callMaestrano($this->_receive_http_operation, $this->_receive_rest_entity_name . '/' . $notification->id);
    }
	...
	$this->_mno_request_message = $message = $this->build();
	...
	$this->_mno_response_id = $mno_response_id = $response->id;
    ...
    public function sendDeleteNotification($local_id) {
        ...
        $this->_log->debug(__FUNCTION__ . " mno_id entry = " . json_encode($mno_id));
    ...
    * 	     	object->entity  	entity name related to ID
    */
    public function getLocalIdByMnoIdName($mnoId, $mnoEntityName, $local_entity_name=null)
    {
        return $this->_mno_soa_db_interface->getLocalIdByMnoIdName($mnoId, $mnoEntityName, $local_entity_name);
    }
    
    public function getLocalIdsByMnoIdName($mno_id, $mno_entity_name)
    {
        return $this->_mno_soa_db_interface->getLocalIdsByMnoIdName($mno_id, $mno_entity_name);
    }
    ...
    public function isValidIdentifier($id_obj) {
